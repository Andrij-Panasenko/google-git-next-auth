  ...
  return (
    <>
      <div className="container m-auto mt-10 py-6 px-10">
        <div className="flex justify-between bg-white border-b border-gray-300 py-6 px-10">
        ...
        <div className="bg-gray-100 py-12 px-8">
          <ul className="flex gap-10">
            <li className=" flex-grow bg-white space-y-5 p-6 shadow-lg shadow-gray-300/50">
              <Image
                width={16}
                height={16}
                src="/icons/check.svg"
